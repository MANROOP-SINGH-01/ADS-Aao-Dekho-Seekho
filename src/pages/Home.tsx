    ...
    <div className="home-page">
      ...
      <footer className="brutal-footer">
        ...
        <div className="footer-bottom-bar font-mono">
          <span>© {new Date().getFullYear()} ADSA VISUAL LAB. ALL RIGHTS RESERVED.</span>
          <span>NO PURPLE AI GRADIENTS • PURE HIGH-CONTRAST LABORATORY</span>
        </div>
      </footer>
